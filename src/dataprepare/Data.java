...
public class Data {
    ...
    public Data(String userStr, String productStr, String reviewText, int goldRating, String propertyStr) {
    ...
    public Data(String userStr, String productStr, String reviewText, int goldRating) {
        this.userStr = userStr;
        this.productStr = productStr;
        this.reviewText = reviewText;
        this.goldRating = goldRating;
    ...
    public Data(String userStr, String productStr, String[] xWords, int goldRating) {
        this.userStr = userStr;
        this.productStr = productStr;
        this.goldRating = goldRating;
        this.predictedRating = -1;
    ...
    // FIXME //not work
    public String toPredString() {
        return userStr + "\t\t" + productStr + "\t\t" + predictedRating + "\t\t" + reviewText;
    }
}
