...
public class Funcs {
    ...
    public static void loadEmbeddingFile(String embedFile, int embeddingLength, String encoding, boolean isL2Norm,
        HashMap<String, Integer> vocabMap, double[][] table) throws IOException {
        BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(embedFile), encoding));
        String line = null;
    ...
    public static HashMap<String, Double[]> loadEmbedFile(String embedFile, int embeddingLength, String encoding,
    ...
    public static void dumpEmbedFile(String embedFile, String encoding, HashMap<String, Integer> vocabMap,
        double[][] table, int embeddingLength) {
        ...
        try {
            PrintWriter writer =
                new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(embedFile), encoding)));
    ...
    public static void loadCorpus(String inPath, String encoding, HashMap<String, List<Data>> trainingDatas,
        String userORproduct, int minFreq) {
    ...
    public static void filterDataWithFreq(String inPath, String encoding, int minUserFreq, int minItemFreq)
        throws IOException {
        ...
        System.out.println(
            "saved user / all user (minUserFreq = " + minUserFreq + "): " + userList.size() + "/" + userCounter.size());
        System.out.println(
            "saved item / all item (minItemFreq = " + minItemFreq + "): " + itemList.size() + "/" + itemCounter.size());
        ...
        for (int i = 0; i < datasets.size(); i++) {
            ...
            if (userList.contains(data.userStr) && itemList.contains(data.productStr)) {
                savedList.add(data);
                continue;
            }
            removedIds.add(i);
        ...
        System.out
            .println("saved reviews / all reviews: " + (datasets.size() - removedIds.size()) + "/" + datasets.size());

        dumpCorpus(savedList, inPath + "-" + minUserFreq + "-" + minItemFreq, "utf8");

    }

    public static void dumpCorpus(List<Data> datasets, String outpath, String encoding) throws IOException {
        PrintWriter writer =
            new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(outpath), encoding)));
        for (Data data : datasets) {
            writer.write(
                data.userStr + "\t\t" + data.productStr + "\t\t" + data.goldRating + "\t\t" + data.reviewText + "\n");
        }
        writer.close();
    }

    public static void loadSegCorpus(String inPath, String encoding, HashMap<String, List<Data>> trainingDatas,
        String userORproduct, int minFreq) {
    ...
    public static void loadSegCorpus(String inPath, String encoding, List<Data> trainingDatas) {
        try {
            BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(inPath), encoding));
            String line = null;
            while ((line = reader.readLine()) != null) {
                String[] splits = line.split("\t\t");
    ...
    public static void loadCorpus(String inPath, String encoding, List<Data> trainingDatas) {
        try {
            BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(inPath), encoding));
            String line = null;
            while ((line = reader.readLine()) != null) {
    ...
    public static void minLengthSentence(List<String> trainFiles, String encoding) {
        int minLength = 999999;
        for (String fileP : trainFiles) {
            System.out.println("running " + fileP);
            try {
                BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(fileP), encoding));
                String line = null;
                while ((line = reader.readLine()) != null) {
    ...
    public static void loadVocabFromFile(String vocabFile, HashMap<String, Integer> vocabMap, String encoding) {
        try {
            BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(vocabFile), encoding));
            String line = null;
            while ((line = reader.readLine()) != null) {
    ...
    public static void filterMapWithFreq(HashMap<String, Integer> origFreatureFreqMap, int minFreq,
    ...
    public static void dumpVocab(HashMap<String, Integer> hashMap, String outputFile, String encoding) {
        ...
        try {
            PrintWriter writer =
                new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(outputFile), encoding)));
    ...
    public static int[][] fillDocument(String[] sentences, HashMap<String, Integer> vocabMap, String unkWord,
    ...
    public static int[][] fillDocument(String[] sentences, HashMap<String, Integer> vocabMap) {
        int[][] wordMatrix = new int[sentences.length][];
        for (int i = 0; i < wordMatrix.length; i++) {
            String[] words = sentences[i].trim().split(" ");
    ...
    public static int[] fillSentence(String[] words, HashMap<String, Integer> vocabMap) {
