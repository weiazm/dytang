...
public class LookupLinearTanh implements NNInterface, Serializable {
    ...
    public LookupLinearTanh(LookupLayer seedLookup, LinearLayer seedLinear) throws Exception {
    ...
    public LookupLinearTanh(int xWindowSize, int xVocabSize, int xOutputLength, int xEmbeddingLength) throws Exception {
